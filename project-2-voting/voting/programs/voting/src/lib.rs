...
declare_id!("C36xpYU8vzVjKFJwZyGiBeAuAVTw8e98ViPRr5utvmF7");
...
//custome error enumeration
//this macro will define error codes for program
#[error_code]
//this declares a public enumeration mamed ErrorCode. Enumerations (enums) in Rust are used to define a type that can be one of several variants.
pub enum ErrorCode {
